...
function truc(data) {
    ...
    document.getElementById("temperature").innerHTML = "il fait " + data.hourly.temperature_2m[hourlyIndex] + "°C"
    document.getElementById("precip").innerHTML = "il est prévu " + data.hourly.precipitation[hourlyIndex] + "mm de pluie"
